...
# Convert hex font data into a sequence of initializations
# to the elements of the font memory vector. That way,
# the default font is automatically in font memory when
# the display controller starts running.
